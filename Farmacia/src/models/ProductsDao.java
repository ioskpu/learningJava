...
public class ProductsDao {
    ...
    public boolean updatProductQuery(Products product){
    ...
    public boolean deleteProductQuery(int id){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se puede eliminar un producto que tiene relación con otra tabla");
            return false;
        }
    }
    ...
    public Products serachId(int id){
    ...
    //Actualizar stock
    public boolean updatStockQuery(int amount, int product_id){
